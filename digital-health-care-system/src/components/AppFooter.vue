<template>
  <div class="p-20">
    <div class="text-center mb-16">
      <p class="mt-4 text-sm leading-7 text-gray-500 font-regular">THE TEAM</p>
    ...
    <div class="sm:grid grid-cols-2 md:grid-cols-4 col-gap-10 mx-auto">
      <div class="text-center">
        <a href="#"
          ><img
            class="mb-3 rounded-xl mx-auto h-32 w-32"
...
.footer-gradient {
  ...
  background: linear-gradient(to top, #8a3ab9, #e95950); /* Purple gradient */
  z-index: -1; /* Ensure it stays behind the footer content */
}
</style>